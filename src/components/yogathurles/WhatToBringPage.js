                    ...
                    <div className="ribbon bg-image-landing b-border">
                        <div className="container-fluid">
                            ...
                            <div className="row p-b-15 m-t-1-em m-b-1-em">
                                <div className="col-sm-offset-1 col-sm-10 col-12 p-b-15 m-b-1-em">
                                    <div className="mdl-card mdl-shadow--4dp p-3-em text-center allow-overflow">
                                        ...
                                        <div className="row">
                                            <div className="col-md-offset-1 col-sm-4 col-md-2 col-12 wtb-items">
                                            ...
                                            <div className="col-sm-4 col-md-2 col-12 wtb-items">
                                            ...
                                            <div className="col-sm-6 col-md-2 col-12 wtb-items">
